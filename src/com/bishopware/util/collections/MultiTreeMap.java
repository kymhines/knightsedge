...
public class MultiTreeMap<t_key extends Comparable<t_key>, t_value> implements
        Iterable<Entry<t_key, Set<t_value>>> {

    private final TreeMap<t_key, Set<t_value>> m_map = new TreeMap<t_key, Set<t_value>>();
